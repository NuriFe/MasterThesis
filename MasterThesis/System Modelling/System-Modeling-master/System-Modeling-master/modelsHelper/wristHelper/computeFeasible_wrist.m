...
% load muscle models
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('C:\Users\s202421\Documents\GitHub\MasterThesis\Data\model\model_WP.mat')
...
t(:,1) = gp(modeldata.muscle(4).Fx.hyp, @infExact, meanfunc, covfunc, likfunc, modeldata.muscle(4).Fx.trainingInputs(1:sampling:end,:), modeldata.muscle(4).Fx.trainingOutputs(1:sampling:end), q);
t(:,2) = gp(modeldata.muscle(4).Fy.hyp, @infExact, meanfunc, covfunc, likfunc, modeldata.muscle(4).Fy.trainingInputs(1:sampling:end,:), modeldata.muscle(4).Fy.trainingOutputs(1:sampling:end), q);
t(:,3) = gp(modeldata.muscle(4).Fz.hyp, @infExact, meanfunc, covfunc, likfunc, modeldata.muscle(4).Fz.trainingInputs(1:sampling:end,:), modeldata.muscle(4).Fz.trainingOutputs(1:sampling:end), q);
